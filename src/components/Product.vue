      ...
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
          <v-carousel>
            ...
            <v-carousel-item
              :src="require('../assets/img/home/slider3.png')"
            >
            </v-carousel-item>
            <v-carousel-item
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            <p class="display-1 mb-0">Legion Laptop</p>
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">75,000 Rs <del style="" class="subtitle-1 font-weight-thin">85,000 Rs</del></p>
              <v-spacer></v-spacer>
                ...
                >
                  ...
                  >
                    <v-img
                      ...
                      height="200px"
                      :src="require('../assets/img/home/deal1.png')"
                    >
                ...
                >
                  ...
                  >
                    <v-img
                      class="white--text align-end"
                      height="200px"
                      :src="require('../assets/img/home/deal2.png')"
                    >
                      <v-card-title>Mobiles </v-card-title>
                    </v-img>

                    <v-card-text class="text--primary text-center">
                      <div>Upto 5%</div>
                      <div>Apple, Samsung</div>
                    </v-card-text>
                ...
                >
                  ...
                  >
                    <v-img
                      class="white--text align-end"
                      height="200px"
                      :src="require('../assets/img/home/deal5.jpeg')"
                    >
                      <v-card-title>Headphones </v-card-title>
                    </v-img>
        ...
        data: () => ({
            ...
            breadcrums: [
                ...
                },
                {
                    text: 'Electronics',
                    disabled: false,
                    href: 'breadcrumbs_electronics',
                },
                {
                    text: 'Laptops',
                    disabled: true,
                    href: 'breadcrumbs_laptops',
                },
            ],
            item: 5,
            items: [
